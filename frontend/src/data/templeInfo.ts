...
export const TEMPLE_DATA: TempleInfo = {
  ...
  weeklyMeetings: [
    ...
    },
    {
      ...
      description: "Encontro semanal acolhedor conduzido pela devota Manjari Tulasi para aprofundar-se verso a verso nos ensinamentos universais e transformadores do Bhagavad-gītā Como Ele É sob a orientação fidedigna de Srila Prabhupada.",
      bookTitle: "Bhagavad-gītā Como Ele É",
