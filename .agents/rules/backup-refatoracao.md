...
Toda vez que você for realizar uma refatoração estrutural, modularização ou divisão de código em arquivos existentes, é obrigatório criar uma cópia de segurança (backup) do arquivo original antes de aplicar qualquer alteração.
